...
d.text((64,164),'R01 virtual prototype   /   48 × 27 × 13 mm body   /   22 mm textile strap',font=font(19),fill=muted)
...
d.text((64,949),'Built for a manufacturer’s feasibility review.',font=font(27),fill=ink)
d.text((64,995),'Editable CAD source + form-fit STL blanks + component assembly + proposed electronics and verification plan.',font=font(18),fill=muted)
