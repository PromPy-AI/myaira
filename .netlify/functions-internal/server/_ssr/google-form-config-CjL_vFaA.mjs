...
//#region node_modules/.nitro/vite/services/ssr/assets/google-form-config-CjL_vFaA.js
...
var signupSchema = discriminatedUnionType("kind", [objectType({
	...
	email: emailSchema,
	country: stringType().trim().min(1, "Enter your country.").max(100),
...
//#endregion
export { PREBOOK_FORM_ACTION as a, PREBOOK_ENTRY as i, GOOGLE_FORM_EMAIL_ENTRY as n, prebookUsageOptions as o, PREBOOK_DEVICE as r, signupSchema as s, GOOGLE_FORM_ACTION as t };
